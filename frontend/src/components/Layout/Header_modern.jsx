      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="xl:hidden">
            <div className={`flex items-center p-2.5 rounded-2xl border ${getConnectionBadgeColor()}`}>
              {getConnectionIcon()}
              <span className="hidden sm:block ml-2 text-sm font-medium">{connectionStatus}</span>
            </div>
          </div>
            ...
            <AnimatePresence>
              {isUserMenuOpen && (
                <motion.div
                  ...
                  className="fixed right-4 top-16 w-64 bg-white border border-gray-200 shadow-xl z-[9999] rounded-2xl"
