...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <motion.aside
        className="fixed inset-y-0 left-0 z-50 w-72 glass-card border-r-0 lg:relative lg:translate-x-0"
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 pt-0">
            <div className="metric-card bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200/50">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-semibold text-blue-800">Today's Usage</h3>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-blue-800">12.4 kWh</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-blue-700">Cost</span>
                  <span className="font-bold text-blue-800">₹89.20</span>
                </div>
